...
public class SearchEmployee extends JInternalFrame {
	...
	private String rowRec[][]; // String Type Array use to Load Records into
								// File.
	...
	public SearchEmployee() {
		...
		String records[][] = new String[500][4]; // String Type Array use to
													// Load Records From Table.

		try { // Opening the Required Table.
			String q = "SELECT * FROM members ORDER BY Member"; // Query use to
																// Retrieve the
																// Records.
		...
		//st = con.createStatement(); // Creating Statement Object.
			...
			while (rs.next()) {
				records[rec][0] = "" + rs.getLong("Member");
