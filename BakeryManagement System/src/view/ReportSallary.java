...
public class ReportSallary extends JInternalFrame implements ActionListener {
	...
	public ReportSallary(JFrame getParentFrame)

	{
		...
		GenerateBtn = new JButton("Create Report");
		GenerateBtn.addActionListener(this);
		panel4.add(GenerateBtn);

		////// Report Variables

		Lblcollege2 = new JLabel("GOLAM BAKERY EMPLOYEE SALLARY REPORT");
		Lbldate = new JLabel("   Date :");
		LblSalary_Slip = new JLabel("   Salary Slip of Employee :");
		LblBasic_Pay = new JLabel("   Basic Pay :");
		LblAllowance = new JLabel("############### A  L  L  O  W  A  N  C  E ###############");
		LblDeduction = new JLabel("############### D  E  D  U  C  T  I  O  N ###############");
		LblDA = new JLabel("    Medical :");
		LblHRA = new JLabel("    Attendence :");
		LblWA = new JLabel("    Transaction :");
		LblGPF = new JLabel("    Absence :");
		LblIT = new JLabel("    Tax :");
		LblGIS = new JLabel("    Shelter :");
		LblPF = new JLabel("    Loan :");
		LblLIC = new JLabel("    Meal :");
		...
		PrintBtn = new JButton("Pre", new ImageIcon("images/prints.png"));
	...
	public void actionPerformed(ActionEvent event) {
		...
		if (source == PrintBtn) {
			Printpreview prn = new Printpreview();
